        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div>
            <a href="/" className="mb-4 inline-block">
              <Image src={assetPath("/images/iron-oak-cross.webp")} alt="Iron & Oak" width={120} height={120} className="w-14 h-14" />
            </a>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.youtube.com/@IronAndOakPodcast" target="_blank" rel="noopener noreferrer" className="p-2 -m-2 text-[var(--text-secondary)] hover:text-[var(--accent-oak)] transition-colors duration-300" aria-label="YouTube">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
              <a href="https://www.instagram.com/ironandoakpodcast" target="_blank" rel="noopener noreferrer" className="p-2 -m-2 text-[var(--text-secondary)] hover:text-[var(--accent-oak)] transition-colors duration-300" aria-label="Instagram">
              ...
              <a href="https://open.spotify.com/show/ironandoakpodcast" target="_blank" rel="noopener noreferrer" className="p-2 -m-2 text-[var(--text-secondary)] hover:text-[var(--accent-oak)] transition-colors duration-300" aria-label="Spotify">
              ...
              <a href="https://podcasts.apple.com/us/podcast/iron-and-oak-podcast" target="_blank" rel="noopener noreferrer" className="p-2 -m-2 text-[var(--text-secondary)] hover:text-[var(--accent-oak)] transition-colors duration-300" aria-label="Apple Podcasts">
